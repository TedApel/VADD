  ...
  public:
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec3[0] = (iRec3[1] + 1);
			table[i] = std::sin((0.000191747604f * float((iRec3[0] + -1))));
			iRec3[1] = iRec3[0];
		}
	}
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = (4.0f * mydsp_faustpower2_f(fConst0));
		fConst4 = (3.14159274f / fConst0);
		fConst5 = (2.0f / fConst0);
		fConst6 = (2.0f * fConst0);
		fConst7 = (0.5f / fConst0);
		fConst8 = (2.0f * fConst2);
		fConst9 = (1.0f / std::tan((62.831852f / fConst0)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("sonify");
		ui_interface->addHorizontalSlider("Frequency", &fHslider0, 100.0f, 0.0f, 150.0f, 0.00999999978f);
		ui_interface->addHorizontalSlider("Range", &fHslider1, 100.0f, 0.0f, 100.0f, 0.00999999978f);
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = std::tan((fConst4 * (fSlow0 + 8.0f)));
		float fSlow2 = mydsp_faustpower2_f(std::sqrt((fConst3 * (std::tan((fConst4 * (fSlow0 + -8.0f))) * fSlow1))));
		float fSlow3 = (fConst2 * fSlow2);
		float fSlow4 = (fConst5 * ((fConst6 * fSlow1) - (fConst7 * (fSlow2 / fSlow1))));
		float fSlow5 = (1.0f / ((fSlow3 + fSlow4) + 4.0f));
		float fSlow6 = ((fConst8 * fSlow2) + -8.0f);
		float fSlow7 = float(fHslider1);
		float fSlow8 = (fSlow3 + (4.0f - fSlow4));
		float fSlow9 = (fSlow3 + 4.0f);
		for (int i = 0; (i < count); i = (i + 1)) {
			float fTemp0 = float(input0[i]);
			fVec0[0] = fTemp0;
			fRec5[0] = (0.0f - (fConst10 * ((fConst11 * fRec5[1]) - (fTemp0 + fVec0[1]))));
			float fTemp1 = (fRec4[1] + (fConst1 * (fSlow0 + (fSlow7 * fRec5[0]))));
			fRec4[0] = (fTemp1 - std::floor(fTemp1));
			float fTemp2 = (fSlow6 * fRec2[1]);
			fRec2[0] = (ftbl0mydspSIG0[int((32768.0f * fRec4[0]))] - (fSlow5 * (fTemp2 + (fSlow8 * fRec2[2]))));
			float fTemp3 = (fSlow6 * fRec1[1]);
			fRec1[0] = (fSlow5 * (((fTemp2 + (fSlow9 * fRec2[0])) + (fSlow9 * fRec2[2])) - (fTemp3 + (fSlow8 * fRec1[2]))));
			float fTemp4 = (fSlow6 * fRec0[1]);
			fRec0[0] = (fSlow5 * (((fTemp3 + (fSlow9 * fRec1[0])) + (fSlow9 * fRec1[2])) - (fTemp4 + (fSlow8 * fRec0[2]))));
			output0[i] = FAUSTFLOAT((fSlow5 * ((fTemp4 + (fSlow9 * fRec0[0])) + (fSlow9 * fRec0[2]))));
			fVec0[1] = fVec0[0];
			fRec5[1] = fRec5[0];
			fRec4[1] = fRec4[0];
			fRec2[2] = fRec2[1];
	...
	#define FAUST_FILE_NAME "sonify.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Frequency", fHslider0, 100.0f, 0.0f, 150.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Range", fHslider1, 100.0f, 0.0f, 100.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Frequency, "Frequency", fHslider0, 100.0f, 0.0f, 150.0f, 0.01f) \
		p(HORIZONTALSLIDER, Range, "Range", fHslider1, 100.0f, 0.0f, 100.0f, 0.01f) \
...
sonify::sonify() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void sonify::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void sonify::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float sonify::getParamValue(const std::string& path)
{
